...
- [ ] **Phase 40: Hypothesis Engine** — Agent forms attack hypothesis from any detection event before investigating; generates hypotheses from SCOPE audit run directory and exploit output; operator selects which hypothesis to hunt when given an audit run directory (HYPO-01 through HYPO-04) (plan 40-01 done: `<hypothesis_engine>` section inserted)
...
*Last updated: 2026-03-30 — Phase 40 plan 40-01 complete (<hypothesis_engine> section; HYPO-01 through HYPO-04)*
