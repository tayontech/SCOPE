...
```
  ...
  │   • Resource identifiers stay session-scoped unless approved for knowledge update
  │
  ...
  │   • Extracted identifiers stay session-scoped unless approved for knowledge update
  └──────────────────────────────────────────────────
```
