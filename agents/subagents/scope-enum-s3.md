...
- Edges: public access (external:public -> data:s3:BUCKET_NAME, edge_type: "public_access", access_level: read|write|admin)
...
```bash
MODULE="s3"
OUTPUT_FILE="$RUN_DIR/s3.json"
AGENT_NAME="scope-enum-s3"
REGION="global"
```
