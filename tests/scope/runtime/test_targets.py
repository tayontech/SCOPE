...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("arn:aws:cloudfront::123456789012:distribution/E123ABC", "cloudfront", "cloudfront", None, "distribution", "E123ABC"),
        ...
        ("arn:aws:ecs:us-east-1:123456789012:service/default/api", "ecs", "ecs", "us-east-1", "service", "default/api"),
        ...
        ("arn:aws:route53:::hostedzone/Z123", "route53", "route53", None, "hostedzone", "Z123"),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        "arn:aws:cloudfront:us-east-1:123456789012:distribution/E123ABC",
        "arn:aws:route53:us-east-1::hostedzone/Z123",
