...
- Public endpoint to compute role: an external or public endpoint invocation reaches compute, the compute service executes as a role, and that role can perform an impact action.
