...
Exception: agents may read `knowledge/observations.md` at session start for cross-account environmental patterns, and append notable observations after a run completes (accumulate, don't overwrite).
