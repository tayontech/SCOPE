...
from scope.core.base_enum import KNOWN_MODULES, LazyClientFactory, _call_run_fn, dispatch
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="python -m scope")
    ...
    if args.command == "enum":
        ...
        def run(factory: Any, region: str, selector: Any | None = None):
            ...
            module = importlib.import_module(f"scope.enumerators.{import_name}")
    ...
    if args.command == "audit":
        from scope.runtime.audit import main as audit_main
