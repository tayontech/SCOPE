...
All visualization is handled by the SCOPE dashboard at `http://localhost:3000`. If investigation results need to be visualized, open the dashboard and load the run's results.json.
